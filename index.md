...
<table class="project-list">
  ...
  <tr>
    ...
    <td class="project-body">
      <span class="project-title">iLQR from Scratch (<a href="https://github.com/JamieHuang28/iterative-linear-quadratic-regulator">source code</a>)</span>
  ...
  <tr>
    <td class="project-thumb"></td>
    <td class="project-body">
      <span class="project-title">NanoNonlinearOptimizationSolver (<a href="https://github.com/JamieHuang28/NanoNonlinearOptimizationSolver">source code</a>)</span>
  ...
  <tr>
    ...
    <td class="project-body">
      <span class="project-title">underwater-cleaning-robot-ros (<a href="https://github.com/JamieHuang28/underwater-cleaning-robot-ros">source code</a>)</span>
