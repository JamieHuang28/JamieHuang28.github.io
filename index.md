...
On July and August of 2026, [Patch Policy(in JEPA)](https://arxiv.org/abs/2607.18236) and [Q-LEARNING WITH WORLD MODELS](https://arxiv.org/pdf/2608.17163) are published. They are all about how to learn with fewer shots, yet no open-source implementation is available.
...
[MAML](https://arxiv.org/abs/1703.03400) is an algorithm which can "pretrain" NN with few-shot. And it is applicable to all learning without any change. This document is a clear note trying to clearly illustrate this classic work.
